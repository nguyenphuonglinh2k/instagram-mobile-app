...
import {
    Text, View, Image, StyleSheet, SafeAreaView, TextInput, StatusBar,
    TouchableWithoutFeedback, Keyboard, TouchableOpacity
} from "react-native";
import KeyboardAvoidingView from "react-native/Libraries/Components/Keyboard/KeyboardAvoidingView";
import { LinearGradient } from "react-native-text-gradient";
...
export default class Signin extends Component {
    ...
    checkAccount = () => {
        if (this.state.email === "abc@gmail.com" && this.state.password === "123456") {
            this.setState({
                logined: true
            })
        }
                            ...
                            <View style={styles.signinContainer}>
                                ...
                                {this.state.correctInfor == false &&
                                    <View style={{ right: 36, top: 148, position: "absolute" }}>
                                        <Text style={styles.incorrectInfor}>Information is incorrect !</Text>
                                    </View>
                                }
